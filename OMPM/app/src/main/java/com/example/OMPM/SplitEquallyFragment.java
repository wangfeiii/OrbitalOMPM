...
public class SplitEquallyFragment extends Fragment {
     ...
     * @return A new instance of fragment SplitEquallyFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static SplitEquallyFragment newInstance(String param1, String param2) {
        SplitEquallyFragment fragment = new SplitEquallyFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_split_equally, container, false);
        ...
        if (permission!= PackageManager.PERMISSION_GRANTED) {
            ...
            //initialize widgets
            RadioGroup radioGroup = view.findViewById(R.id.toggleGroup);
            int option = radioGroup.getCheckedRadioButtonId();

            gst = view.findViewById(R.id.checkBox_GST);
            sc = view.findViewById(R.id.Service_Charge);
            ...
            bill = view.findViewById(R.id.input);
